...
using FTParking.Services;

#if WINDOWS_APP
using Windows.System;
using Windows.UI.Core;
using Windows.UI.ApplicationSettings;
using FTParking.AppFlyouts;
#endif
...
namespace FTParking
{
    ...
    {
        private Guid APP_ID = new Guid("29b68e9b-1f30-40b9-bc34-f38e5f1205f1");
        public const string APP_NAME = "FT Parking";
        ...
        private void UpdateAppTiles()
        {
            ...
            {
                TileServices.CreateFlipTile(@"FT Parking", @"");
