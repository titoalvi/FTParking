...
{
    public class ParkingSlotConfig : SectionConfigBase<LocalStorageDataConfig, MenuSchema>
    {
        ...
        public override LocalStorageDataConfig Config
        {
            get
            {
                ...
                {
                    FilePath = "/Assets/Data/ParkingSlot.json"
                };
            }
        }
        ...
        public override NavigationInfo ListNavigationInfo
        {
            get 
            {
                return NavigationInfo.FromPage("ParkingSlotPage");
            }
        }
